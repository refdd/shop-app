...
function ProductDetailScreen({route , navigation}) {
  ...
  const despatch = useDispatch()
    const  selectedProduct = useSelector(state => state.products.availableProdusts.find(prop => prop.id === productId))
  ...
  return (
    ...
    <Button  color={Color.primary} title='Add to Cart ' onPress={()=> despatch(cartAction.addToCart(selectedProduct)) } />
